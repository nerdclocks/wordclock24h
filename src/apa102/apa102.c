...
/*-----------------------------------------------------------------------------------------------------------------------------------------------
 * SPI for data: DMA1, channel ?, SPI2
 *-----------------------------------------------------------------------------------------------------------------------------------------------
 */
...
apa102_init (void)
{
    ...
    APA102_GPIO_PORT->BSRRH = APA102_GPIO_SCK_PIN;              // set SCK to Low
    ...
    GPIO_Init(APA102_GPIO_PORT, &gpio);
    GPIO_WriteBit(APA102_GPIO_PORT, APA102_GPIO_SCK_PIN, RESET);    // set SCK to Low
