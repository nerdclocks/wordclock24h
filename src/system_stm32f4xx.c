...
#if defined (STM32F401RE) || defined (STM32F411RE)  // STM32F401/STM32F411 Nucleo Board with 8MHz crystal
#define PLL_M      8
#define PLL_N      336
#define PLL_P      4
#define PLL_Q      7
...
/******************************************************************************/
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        RCC->CFGR &= ~(RCC_CFGR_PPRE2);             // SET APB2 High speed prescaler APB2 to DIV1, alternatively: RCC->CFGR |= RCC_CFGR_PPRE2_DIV1;
